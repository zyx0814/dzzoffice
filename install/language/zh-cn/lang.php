...
$lang = array(
    ...
    'to_back' => '返回上一步',
    'php_version_too_low' => 'php版本不支持，仅支持php7.4+',
    'SC_UTF8' => '简体中文 UTF8 版',
    ...
    'ext_info_succ' => '安装成功。',
    'install_submit' => '提交',
    'install_locked' => '安装锁定，已经安装过了，如果您确定要重新安装，请到服务器上删除' . str_replace(ROOT_PATH, '', $lockfile),
    'step_app_reg_title' => '设置运行环境',
    'step_app_reg_desc' => '检测服务器环境',
    'advice_mysql_connect' => '请检查 mysql 模块是否正确加载',
    'advice_gethostbyname' => '是否 PHP 配置中禁止了 gethostbyname 函数。请联系服务商，确定开启了此项功能',
    'advice_file_get_contents' => '该函数需要 php.ini 中 allow_url_fopen 选项开启。请联系服务商，确定开启了此项功能',
    'advice_xml_parser_create' => '该函数需要 PHP 支持 XML 扩展，请联系服务商，确定开启了此项功能',
    'advice_json_encode' => '该函数需要 PHP 支持 JSON 扩展。请联系服务商，确定开启了此项功能',
    ...
    'system_data_installation_successful' => '系统数据安装成功！',
    'install_successfully' => '系统安装成功，感谢您的支持！',
