...
class baiduRequestCore {
    ...
    /**
     * The default class to use for HTTP Requests (defaults to <baiduRequestCore>).
     */
...
// 		}
     ...
     * @return baiduResponseCore A <baiduResponseCore> object containing a parsed HTTP response.
     */
     ...
     *
     * @param boolean $parse (Optional) Whether to parse the response with baiduResponseCore or not.
    ...
    /* 	public function send_multi_request($handles, $opt = null) {
      ...
      if ($done ['result'] > 0) {
      throw new baiduRequestCore_Exception ( 'cURL resource: ' . ( string ) $done ['handle'] . '; cURL error: ' . curl_error ( $done ['handle'] ) . ' (' . $done ['result'] . ')' );
...
class baiduResponseCore {
     ...
     * Constructs a new instance of this class.
     *
     * @param array $header (Required) Associative array of HTTP headers (typically returned by <baiduRequestCore::get_response_header()>).
...
/**
 * Default baiduRequestCore Exception.
 */
class baiduRequestCore_Exception extends Exception {
