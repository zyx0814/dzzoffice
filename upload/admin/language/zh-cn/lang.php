...
//	'misc_cron_day' => '日',
	...
	'clear_application_install'=>'从所有已安装此应用的用户中清除',
	...
	'extopen_board_message_text'=>'<li>排序：值越大越靠后</li>
	...
	//admin/app/cp.php
	'list_cp_Application_directory_exist'=>'应用目录不存在，请将应用文件放入dzz/下后重试!',
...
<li>8、若需导入的人员较多，建议先做一个少量人员的测试表，测试无误后，再使用增量方式导入所有用户。</li>',
	...
	'seeting_wxsyn_bound_state'=>'<li>一般只有初次绑定时才需要在此同步</li><li>同步操作会把本站的机构和部门及机构和部门下的用户同步到微信企业号</li><li>机构和用户管理里的操作会自动同步到微信端，不需要在此手工同步</li><li>此同步不会把微信企业号内的机构和部门及用户同步到本站</li><li>不在同步范围的用户，如果用户已经在微信中存在，将在微信中禁用此用户</li>',
