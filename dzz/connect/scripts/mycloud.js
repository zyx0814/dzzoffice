...
function Todesktop(id,bz){
	parent._ico.ShortCut('icoid_'+id);return
}
...
jQuery(document).ready(function(e) {
    ...
    jQuery('.thumbnails li').mouseenter(function(){
		...
		if(jQuery(this).hasClass('Selected')){
			html+='<li><a href="javascript:;" onclick="Open(\''+icoid+'\');return false">打开</a></li>';
			if(bz!='dzz') html+='<li><a href="javascript:;" onclick="Delete(\''+cid+'\',\''+bz+'\');return false">删除</a></li>';
			html+='<li><a href="javascript:;" onclick="Rename(\''+cid+'\',\''+bz+'\');return false">重命名</a></li>';
			html+='<li><a href="javascript:;" onclick="Todesktop(\''+cid+'\',\''+bz+'\');return false">添加到桌面</a></li>';
		}
