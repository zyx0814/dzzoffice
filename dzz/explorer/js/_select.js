...
_select.SelectedStyle=function(container,rid,flag,multi){
	...
	if(flag){
		//if(!_explorer.FileSPower(_explorer.sourcedata.icos[rid].sperm,'delete')) return;
		//if(!_explorer.Permission('drag',_explorer.sourcedata.icos[rid])) return;
		//if(_explorer.sourcedata.icos[rid].notdelete>0 && _explorer.sourcedata.icos[rid].type!='app') return;
		//if(!_explorer.FileSPower(_explorer.sourcedata.icos[rid].sperm,'move')) return;
	}
