...
dzzattach.init=function(root){
	...
	jQuery(root).find('.dzz-attach .dzz-attach-title')
		...
		.on('mouseover',function(){
			...
			html+='<a class="preview" href="javascript:;" data-id="'+this.id+'" onclick="return dzzattach.preview(\''+this.id+'\',\'attach\')" ><i class="dzz dzz-visibility dzzattach-i"></i>'+__lang.preview+'</a><a class="download" href="javascript:;" data-id="'+this.id+'" onclick="return dzzattach.download(this);" ><i class="dzz dzz-download dzzattach-i"></i>'+__lang.download+'</a><a class="saveto" href="javascript:;" data-id="'+this.id+'" onclick="return dzzattach.saveto(this,\'attach\');" ><i class="dzz dzz-save dzzattach-i"></i>'+__lang.js_saved_my_documents+'</a>';
			html+='</div>';
