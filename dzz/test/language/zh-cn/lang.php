...
$lang = array (
    ...
    'field_subtitle'=>'副标题' ,//字段类 的语言统一以field_ 开头
    
    'field_subtitle_tip'=>'副标题说明' ,//字段说明类 的语言统一以在字段类的基础上加_info 结束
    
    'info_test_desc'    =>'这里编写自己的模板代码<br><br>默认已经引入了：<b>jQuery 1.10</b>、<b>bootstrap V3 css</b> 和 <b>dzz.api.js</b>', //说明类 的语言统一以  info_开头
    'info_title1'=>'应用开发示例',
