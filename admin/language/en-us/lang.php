...
(
    ...
    'app_show_taskbar_text' => 'Certain special applications can be set to not show the taskbar',
    ...
    'top' => 'Top',
    'bottom' => 'Bottom',
    'default_taskbar_position' => 'Default taskbar position. (User settings take precedence after being set by the user)',
