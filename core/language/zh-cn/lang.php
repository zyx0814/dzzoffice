...
//	'login_username' => '用户名',
    ...
    'read_my_file' => '查看（自己的）',
    'read_my_file1' => '查看（所有的）',
    'delete_my_file' => '删除（自己的）',
    'delete_all_file' => '删除（所有的）',
    'edit_my_file' => '编辑（自己的）',
    'edit_all_file' => '编辑（所有的）',
    'upload_my_file' => '下载（自己的）',
    'upload_all_file' => '下载（所有的）',
    'copy_my_file' => '复制（自己的）',
    'copy_all_file' => '复制（所有的）',
    ...
    'file_read_no_privilege' => '抱歉！您没有该文件的预览(查看)权限',
    'folder_read_no_privilege' => '抱歉，您没有该目录的预览(查看)权限',
    ...
    'file_copy_no_privilege' => '抱歉！您没有该文件的复制权限',
    'file_delete_no_privilege' => '抱歉！您没有该文件的删除权限',
    'file_share_no_privilege' => '抱歉！您没有该文件的分享权限',
    'folder_upload_no_privilege' => '抱歉！您没有该目录的上传权限',
    'folder_newfolder_no_privilege' => '抱歉！您没有该目录的新建文件夹权限',
    ...
    'my_username' => '允许修改用户名',
    'org_group' => '组织群组',
    'folder_permissions' => '文件/夹权限',
    'folder_permission_range' => '文件/夹权限范围',
    'folder_property_group_permission' => '文件/夹属性用于部门、群组中创建文件/夹的权限',
    'edit_folder_permissions' => '编辑文件/夹权限',
    'folder_permission_name' => '文件/夹权限名称',
    'my_self' => '我自己',
    'app_version' => '应用版本',
    'content' => '内容',
    'keywords' => '关键词',
