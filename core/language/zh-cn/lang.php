...
$lang = array(
    ...
    'remove_error_check_the_content' => '删除错误！请检查以下内容：<br><ul class="list-group list-group-numbered"><li class="list-group-item">此部门没有下级部门</li><li class="list-group-item">此部门共享目录下没有文件或子目录(包含回收站文件)</li></ul>',
...
//	'type_music'=>'音乐',
    ...
    'folder_not_exist' => '目录可能不存在、已被删除或您无相应权限。',
...
//	'profile_edit' => '修改',
    ...
    'login_succeed_no_redirect' => '登录成功，现在将转入登录前页面',
    'login_strike' => '密码错误次数过多，请 {forbiddentime} 秒后重新登录',
    'logout_succeed' => '您已退出站点，现在将以游客身份转入退出前页面，请稍候……',
    'register_activation_invalid' => '抱歉，激活失败，请重新登录验证需要激活的用户',
    'profile_nickname_tooshort' => '抱歉，您输入的昵称小于 3 个字符，请输入一个较长的昵称',
    'profile_nickname_toolong' => '抱歉，您输入的昵称大于 30 个字符，请输入一个较短的昵称',
    ...
    'profile_username_toolong' => '抱歉，您输入的用户名大于 30 个字符，请输入一个较短的用户名',
...
//	'location_login_succeed' => '',
    ...
    'config_notfound' => '配置文件 "config/config.php" 未找到或者无法访问， 请确认您已经正确安装了程序',
    ...
    'db_error_no' => '错误代码',
    'db_notfound_config' => '配置文件 "config/config.php" 未找到或者无法访问。',
    'db_notconnect' => '无法连接到数据库服务器',
    'db_security_error' => '查询语句安全威胁',
    'db_query_sql' => '查询语句',
    'db_query_error' => '查询语句错误',
    'db_config_db_not_found' => '数据库配置错误，请仔细检查 config/config.php 文件',
...
//	'login_username' => '用户名',
    ...
    'folder_read_no_privilege' => '抱歉，您没有该目录的预览权限',
    'file_download_no_privilege' => '抱歉！您没有该文件的下载权限',
    'file_edit_no_privilege' => '抱歉！您没有该文件的编辑权限',
    'file_new_no_privilege' => '抱歉！您没有该目录的新建权限',
    'file_comment_no_privilege' => '抱歉！您没有该文件的评论权限',
    'folder_comment_no_privilege' => '抱歉！您没有该目录的评论权限',
    ...
    'sec' => '秒',
    'guest' => '游客',
    'please_select_at_least_one_row' => '请至少选择一行',
    'to' => '从',
    'to_date' => '至',
    'no_related_data' => '暂无相关数据',
    'all_comments' => '所有评论列表',
    'current_comments' => '当前评论列表',
    'unknown' => '未知',
    'nickname' => '昵称',
    'user_nickname' => '用户昵称',
