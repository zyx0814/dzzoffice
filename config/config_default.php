...
$_config['security']['error']['showerror'] = '1';//是否在数据库或系统严重异常时显示错误详细信息，0=不显示(更安全)，1=显示详细信息(不安全)，2=只显示错误本身
...
$_config['debug'] = 0; //调试模式 2：全部错误都显示，1：只显示致命的错误，0：关闭调试，'debug'：只有在url后面加上&debug=debug才会显示。打开后可以在页面底部显示程序运行时间和内存开销等信息
