	...
	if(!e.jstree) {
		...
		l.setAttribute("role", "treeitem"), c = d.createElement("I"), c.className = "jstree-icon jstree-ocl", l.appendChild(c), c = d.createElement("A"), c.className = "jstree-anchor", c.setAttribute("href", "#"), h = d.createElement("I"), h.className = "jstree-icon jstree-themeicon", c.appendChild(h), l.appendChild(c), c = h = null, e.jstree = {
				...
				init: function(t, i) {
					...
					}).remove(), this.element.html("<ul class='jstree-container-ul'><li class='jstree-initial-node jstree-loading jstree-leaf jstree-last'><i class='jstree-icon jstree-ocl'></i><a class='jstree-anchor' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" + this.get_string("<div class='loader'><div class='loader-inner ball-beat'><div></div> <div></div> <div></div> </div> </div>") + "</a></li></ul>"), this._data.core.li_height = this.get_container_ul().children("li:eq(0)").height() || 18, this.trigger("loading"), this.load_node("#")					
				},
				destroy: function() {
				...
				redraw_node: function(t, i, n) {
					...
					if(_.length && (t.childNodes[1].className = "jstree-anchor " + _), (r.icon && r.icon !== !0 || r.icon === !1) && (r.icon === !1 ? t.childNodes[1].childNodes[0].className += " jstree-themeicon-hidden" : -1 === r.icon.indexOf("/") && -1 === r.icon.indexOf(".") ? t.childNodes[1].childNodes[0].className += " " + r.icon + " jstree-themeicon-custom" : (t.childNodes[1].childNodes[0].style.backgroundImage = "url(" + r.icon + ")", t.childNodes[1].childNodes[0].style.backgroundPosition = "center center", t.childNodes[1].childNodes[0].style.backgroundSize = "contain", t.childNodes[1].childNodes[0].className += " jstree-themeicon-custom")), t.childNodes[1].innerHTML += r.text, i && r.children.length && r.state.opened && r.state.loaded) {
				...
				refresh: function(t) {
					...
					t || this.element.html("<ul class='jstree-container-ul'><li class='jstree-initial-node jstree-loading jstree-leaf jstree-last'><i class='jstree-icon jstree-ocl'></i><a class='jstree-anchor' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" + this.get_string("<div class='loader'><div class='loader-inner ball-beat'><div></div> <div></div> <div></div> </div> </div>") + "</a></li></ul>"), this.load_node("#", function(t, n) {
				...
				edit: function(i, n) {
					...
					var oldtext = "string" == typeof n ? n : this.get_text(i),texticonpreg = /<(.+?)>(.+?)<\/(.+?)>/;
                    var oldicon = '';
					var matchold = oldtext.match(texticonpreg);
					if(matchold){
                        oldicon = matchold[0];
					}
					var r = this._data.core.rtl,
						...
						o = e("<span>"),
						d = "string" == typeof n ? n : this.get_text(i).replace(/<(.+?)>(.+?)<\/(.+?)>/,''),
						l = e("<div />", {
							css: {
								position: "absolute",
								top: "-200px",
						...
						c = e("<input />", {
							...
							blur: e.proxy(function() {
								var e = o.children(".jstree-rename-input"),
									t = e.val(),newd = d;
								if(t == d) newd = oldicon+d;
								"" === t && (t = d), l.remove(), o.replaceWith(a), o.remove(), this.set_text(i, newd), this.rename_node(i, t) === !1 && this.set_text(i, newd)
							}, this),
							keydown: function(e) {
								var t = e.which;
